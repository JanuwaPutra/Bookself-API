...
const getAllBooksHandler = (request, h) => {
    ...
    if (reading) {
        ...
        ? bookshelf.filter((book) => book.reading === true) : bookshelf.filter((book) => book.reading === false);
    ...
    if (finished) {
        ...
        ? bookshelf.filter((book) => book.finished === true) : bookshelf.filter((book) => book.finished === false);
